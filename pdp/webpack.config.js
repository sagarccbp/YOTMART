...
module.exports = (_, argv) => ({
  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        "./PDPScreen": "./src/components/PDPScreen/PDPScreen.jsx",
        "./ApiService": "./src/rest/ApiService.js",
        "./Stars": "./src/components/PDPScreen/Stars/Stars.jsx",
        "./MagnifierImages":
          "./src/components/MagnifierImages/MagnifierImages.jsx",
        "./CustomerReviews":
