...
const PhonePeModel = require("../models/phone-pe");
...
router.post("/", checkAuth, async (req, res, next) => {
  ...
  const phonePeModel = PhonePeModel({
    amount: amount,
    user: userId,
    cart: cartId,
    address: addressId,
  ...
  const reqBody = {
    ...
    amount: amount * 100,
    redirectUrl: `${process.env.REALFOODS_API}/phonePay/phonePayCallBack`,
    redirectMode: "POST",
    callbackUrl: `${process.env.REALFOODS_API}/phonePay/phonePayCallBack`,
